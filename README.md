...
MUSICDIGGER는 장르를 중심으로 음악을 탐색하는 웹 앱입니다. 장르 카드, 대표 트랙, 연결된 서브장르를 따라가며 새로운 스타일을 발견할 수 있고, Spotify 로그인 시 프로필, 좋아요 트랙, 플레이리스트 기능도 함께 사용할 수 있습니다.
...
- `index.html`: 메인 UI 구조
- `design.css`: 전체 스타일과 테마
- `script.js`: 프론트 상태 관리, 렌더링, Spotify 클라이언트 연동
