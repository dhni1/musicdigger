...
const elements = {
  ...
  vinylModal: document.getElementById('vinyl-player-modal'),
  vinylModalCard: document.getElementById('vinyl-modal-card'),
  vinylModalClose: document.getElementById('vinyl-modal-close'),
  vinylModalPrimary: document.getElementById('vinyl-modal-primary'),
  vinylModalAlbumArt: document.getElementById('vinyl-modal-album-art'),
  vinylModalLabelFallback: document.getElementById('vinyl-modal-label-fallback'),
  vinylModalStatus: document.getElementById('vinyl-modal-status'),
  vinylModalTitle: document.getElementById('vinyl-modal-title'),
  vinylModalArtist: document.getElementById('vinyl-modal-artist'),
  vinylModalAlbum: document.getElementById('vinyl-modal-album'),
  vinylModalProgress: document.getElementById('vinyl-modal-progress'),
  vinylModalProgressFill: document.getElementById('vinyl-modal-progress-fill'),
  vinylModalElapsed: document.getElementById('vinyl-modal-elapsed'),
  vinylModalDuration: document.getElementById('vinyl-modal-duration'),
  ...
  mapStageBody: document.getElementById('map-stage-body'),
  ...
  mapInspectorHead: document.querySelector('#map-inspector .map-inspector-head'),
  mapInspectorClose: document.getElementById('map-inspector-close'),
